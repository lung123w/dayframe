...
**Reason**: The standalone full-page key events view is replaced by the embedded "Key Events This Week" sub-section inside the "Weekly Goals & Key Events" panel in DailyPlanner. There is no longer a dedicated sidebar entry or full-page view for key events.
