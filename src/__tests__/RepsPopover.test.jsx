...
describe('RepsPopover', () => {
  it('renders with initial value of 0 by default', () => {
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={() => {}} />);
    const input = screen.getByRole('spinbutton');
    expect(input.value).toBe('0');
  });

  it('respects an initialValue prop', () => {
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={() => {}} initialValue={15} />);
    const input = screen.getByRole('spinbutton');
    expect(input.value).toBe('15');
  });

  it('increments the value when + is clicked', () => {
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={() => {}} initialValue={5} />);
  ...
  it('cannot decrement below 0 and disables the button', () => {
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={() => {}} initialValue={0} />);
  ...
  it('Save calls onSave with the current value', () => {
    const onSave = vi.fn();
    render(<RepsPopover x={10} y={20} onSave={onSave} onClose={() => {}} initialValue={12} />);
  ...
  it('Enter key calls onSave', () => {
    const onSave = vi.fn();
    render(<RepsPopover x={10} y={20} onSave={onSave} onClose={() => {}} initialValue={7} />);
  ...
  it('Escape key calls onClose', () => {
    const onClose = vi.fn();
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={onClose} />);
  ...
  it('clicking outside calls onClose', () => {
    ...
    render(
      <div>
        ...
        <RepsPopover x={10} y={20} onSave={() => {}} onClose={onClose} />
      </div>
    );
  ...
  it('clicking inside does not call onClose', () => {
    const onClose = vi.fn();
    render(<RepsPopover x={10} y={20} onSave={() => {}} onClose={onClose} />);
    fireEvent.mouseDown(screen.getByRole('spinbutton'));
