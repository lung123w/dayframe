...
Owner: `df-lead` · Last updated: 2026-09-20 (v1.1 — every column re-checked against `server/db.js` CREATE blocks **and** ALTER migrations, plus the live DB; v1.2 — habit `trackType` / entry `count` columns added, `t_74db36be`)
