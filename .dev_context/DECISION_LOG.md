...
Owner: `df-lead` · Last updated: 2026-09-20 (v1.1 — ADR-005…008 re-verified against the code at `master` `526f3b3`; ADR-010…011, CONV-005, POL-006 added)
...
- **Habit count tracking is inert** (ADR-011) — needs two ALTER migrations + route plumbing; the feature currently reads and writes nothing. Fix card: `t_74db36be`.
